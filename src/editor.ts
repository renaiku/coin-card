...
import { CoinCardConfig } from './types';
...
@customElement('coin-card-editor')
export class CoinCardEditor extends LitElement implements LovelaceCardEditor {
  @property({ attribute: false }) public hass?: HomeAssistant;
  @state() private _config?: CoinCardConfig;
  @state() private _toggle?: boolean;
  @state() private _helpers?: any;
  private _initialized = false;

  public setConfig(config: CoinCardConfig): void {
    this._config = config;
  ...
  protected render(): TemplateResult | void {
    ...
    const entities = Object.keys(this.hass.states).filter(
      entity_id => entity_id.substr(0, entity_id.indexOf('.')) === 'sun',
    );
