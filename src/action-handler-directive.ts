...
customElements.define('action-handler-coin', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-coin')) {
    return body.querySelector('action-handler-coin') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-coin');
